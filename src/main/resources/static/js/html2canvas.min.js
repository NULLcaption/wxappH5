...
!function (A, e) {
    ...
    }(U, Math.ceil((24 + U[4]) / 4)), new o(U[0], U[1], U[2], U[3], F, h)), Z = [_, 36], j = [1, 2, 3, 5], $ = [H, 8], AA = [M, S], eA = j.concat($), tA = [J, G, k, V, z], rA = [f, d], BA = (nA.prototype.slice = function () {
    ...
    function pe(A, e, t) {
        ...
        }(A, e, t), B = Math.abs(e * Math.sin(r)) + Math.abs(t * Math.cos(r)), n = e / 2, s = t / 2, o = B / 2, i = Math.sin(r - Math.PI / 2) * o, a = Math.cos(r - Math.PI / 2) * o;
    ...
    var Lr, Or, vr = {
        ...
        matrix: function (A) {
            ...
            var e = A.filter(function (A) {
                ...
                return A.number
            }), t = e[0], r = e[1], B = (e[2], e[3], e[4]), n = e[5], s = (e[6], e[7], e[8], e[9], e[10], e[11], e[12]), o = e[13];
            e[14], e[15];
    ...
    var yB, _B = [{type: sA.DIMENSION_TOKEN, flags: 0, unit: "px", number: 3}], PB = [{
        type: sA.PERCENTAGE_TOKEN,
        flags: 0,
        number: 50
    }], xB = "checkbox", VB = "radio", zB = "password", XB = 707406591, JB = (A(GB, yB = UB), GB);
    ...
    var Bn = ["OL", "UL", "MENU"], nn = function (A, e, t) {
        for (var r = A.firstChild, B = void 0; r; r = B)if (B = r.nextSibling, Qn(r) && 0 < r.data.trim().length)e.textNodes.push(new hB(r, e.styles)); else if (wn(r)) {
            var n = sn(r);
    ...
    var Ln, On, vn = {
        ...
        var B = A.defaultView.pageXOffset, n = A.defaultView.pageYOffset, s = r.contentWindow, o = s.document, i = Jn(r).then(function () {
                ...
                return Gn(e, E), g.content.forEach(function (A) {
                    if (A.type === sA.STRING_TOKEN)E.appendChild(C.createTextNode(A.value)); else if (A.type === sA.URL_TOKEN) {
                        ...
                        if ("attr" === A.name) {
                            ...
                            if (n = i[2], B && zA(B)) {
                                var c = l.counters.getCounterValues(B.value), Q = n && zA(n) ? ir.parse(n.value) : tr.DECIMAL, w = a && a.type === sA.STRING_TOKEN ? a.value : "", u = c.map(function (A) {
                                    return yn(A, Q, !1)
                                }).join(w);
    ...
    var ns = (ss.prototype.subdivide = function (A, e) {
        var t = Bs(this.start, this.startControl, A), r = Bs(this.startControl, this.endControl, A), B = Bs(this.endControl, this.end, A), n = Bs(t, r, A), s = Bs(r, B, A), o = Bs(n, s, A);
    ...
    var is, as, cs = function (A) {
        var e = A.styles, t = A.bounds, r = jA(e.borderTopLeftRadius, t.width, t.height), B = r[0], n = r[1], s = jA(e.borderTopRightRadius, t.width, t.height), o = s[0], i = s[1], a = jA(e.borderBottomRightRadius, t.width, t.height), c = a[0], Q = a[1], w = jA(e.borderBottomLeftRadius, t.width, t.height), u = w[0], U = w[1], l = [];
    ...
    function hs(A) {
        var e = A.styles, t = A.bounds, r = ae(e.paddingLeft, t.width), B = ae(e.paddingRight, t.width), n = ae(e.paddingTop, t.width), s = ae(e.paddingBottom, t.width);
    ...
    function Hs(A, e, t) {
        ...
        }(Ts(A.styles.backgroundClip, e), A), n = Is(Ts(A.styles.backgroundSize, e), t, r), s = n[0], o = n[1], i = jA(Ts(A.styles.backgroundPosition, e), r.width - s, r.height - o);
            ...
            return b(this, function (A) {
                switch (A.label) {
                    ...
                    case 2:
                        s = n = 0, o = r, A.label = 3;
                    case 3:
                        return s < o.length ? (i = o[s]).style === ht.NONE || ee(i.color) ? [3, 5] : [4, this.renderBorder(i.color, n, c.curves)] : [3, 7];
                    case 4:
                        A.sent(), A.label = 5;
                    case 5:
                        n++, A.label = 6;
